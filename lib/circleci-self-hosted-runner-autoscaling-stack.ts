...
export class CircleciSelfHostedRunnerAutoscalingStack extends Stack {
  constructor(scope: Construct, id: string, props?: CircleciSelfHostedRunnerAutoscalingStackProps) {
    ...
    const circleCISecurityGroup = new ec2.SecurityGroup(
      this,
      "CircleCISelfHostedRunnerSecurityGroup",
      {
        vpc: circleCIVpc,
      }
    );
    ...
    const circleCiAutoScalingGroup = new autoscaling.AutoScalingGroup(
      this,
      "CircleCiSelfHostedRunnerASG",
      {
        vpc: circleCIVpc,
    ...
    userDataScript = userDataScript.replace(
      ...
      env.SELF_HOSTED_RUNNER_AUTH_TOKEN
    );
    ...
    const autoScalingLambda = new lambda.Function(
      this,
      "CircleCiSelfHostedRunnerAutoScalingLambda",
      {
